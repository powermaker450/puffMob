...
import { ActivityIndicator, Appbar, Button, Snackbar, Surface, Switch, Text, TextInput } from "react-native-paper";
...
export default function panel_settings() {
  ...
  const handleChange = () => {
    ...
    panel.edit.settings(obj)
      .then(() => {
        ...
        switch (true) {
          case masterUrl !== newMasterUrl:
            setMasterUrl(newMasterUrl)
          case companyName !== newCompanyName:
            setCompanyName(newCompanyName)
          case allowReg !== newAllowReg:
  ...
  return (
    <>
      <Appbar.Header>
        <Appbar.BackAction
          disabled={masterUrl !== newMasterUrl || companyName !== newCompanyName || allowReg !== newAllowReg}
      ...
      <View style={{ width: "90%", alignSelf: "center", bottom: 20 }}>
        <Snackbar
          visible={masterUrl !== newMasterUrl || companyName !== newCompanyName || allowReg !== newAllowReg}
          onDismiss={reset}
          action={{
            label: "Discard",
            onPressIn: handleTouch,
